...
import 'package:flutter_coins_lib/bitcoin_flutter/src/utils/magic_hash.dart';
...
class HDWallet {
  ...
  HDWallet({required bip32.BIP32 bip32, required P2PKH p2pkh, required this.network, this.seed}) {
    _bip32 = bip32;
    _p2pkh = p2pkh;
  }
