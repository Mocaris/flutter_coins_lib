...
import 'handle_big_int.dart';

final zERO32 = Uint8List.fromList(List.generate(32, (index) => 0));
final Uint8List ecGroupORDER =
    Uint8List.fromList(HEX.decode('fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141'));
final Uint8List ecP =
    Uint8List.fromList(HEX.decode('fffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f'));
...
bool isSignature(Uint8List value) {
  ...
  return value.length == 64 && _compare(r, ecGroupORDER) < 0 && _compare(s, ecGroupORDER) < 0;
}
